...
<table class="layui-table" lay-data="{height: 500, cellMinWidth: 80, url:'/college/list', page:true, limit:10, id:'idTest'}" lay-filter="demo">
    <thead>
    <tr>
        ...
        <th lay-data="{field:'userName', width:250}">学院管理员</th>
