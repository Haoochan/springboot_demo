...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a _href="/activityCategory/golist">
                    <i class="iconfont">&#xe6b8;</i>
                    <cite>工作类别</cite>
    ...
    <div class="layui-tab tab" lay-filter="wenav_tab" id="WeTabTip" lay-allowclose="true">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe  src='/activityCategory/golist' frameborder="0" scrolling="yes" class="weIframe"></iframe>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    //			layui扩展模块的两种加载方式-示例
    // 		    layui.extend({
    // 			  admin: '{/}../../WeAdmin/static/js/admin' // {/}的意思即代表采用自有路径，即不跟随 base 路径
    // 			});
    // 			//使用拓展模块
